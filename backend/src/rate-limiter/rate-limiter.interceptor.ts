...
import TooManyRequests from "./exceptions/too-many-requests-exception";
...
export class RateLimiterInterceptor implements NestInterceptor {
  ...
  async intercept(
    ...
    const rateLimiter: RateLimiterMemory = await this.getRateLimiter(
      keyPrefix,
      reflectedOptions
    );
